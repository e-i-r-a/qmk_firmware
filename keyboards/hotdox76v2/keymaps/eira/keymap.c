...
#define MY_C     LOPT_T(KC_C)     //MT(MOD_LOPT, KC_C)
#define MY_V     LCMD_T(KC_V)     //MT(MOD_LCMD, KC_V)
#define MY_M     LCMD_T(KC_M)     //MT(MOD_LCMD, KC_M)
#define MY_COMM  LOPT_T(KC_COMM)  //MT(MOD_LOPT, KC_COMM)
#define MY_DOT   RCTL_T(KC_DOT)   //MT(MOD_RCTL, KC_DOT)
#define MY_SLSH  RSFT_T(KC_SLSH)  //MT(MOD_RSFT, KC_SLSH)
#define MY_RGHT  ROPT_T(KC_RIGHT) //MT(MOD_RALT, KC_RIGHT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `----------+--------+--------+--------+--------+-----------------'           `--------+--------+--------+--------+--------+--------+----------'
     *   | LCtrl  | LCmd   |        |        | Layer4 |                                               | Layer4 | Left   | Down   | Up     | Right  |
     *   |        |        |        |        |        |                                               |        |        |        |        | AltGr  |
     *   `--------------------------------------------'                                               `--------------------------------------------'
     *                                                ,-----------------.           ,-----------------.
    ...
    LAYOUT_ergodox_pretty(
        ...
        KC_LCTL, KC_LCMD, KC_NO,   KC_NO,   MO(4),                                                  MO(4),   KC_LEFT, KC_DOWN, KC_UP,   MY_RGHT,
     ...
     * |          |        |        |        | LOpt   | LCmd   |        |           |        |        |        |        |        |        |          |
     * |----------+--------+--------+--------+--------+--------|        |           |        |--------+--------+--------+--------+--------+----------|
     * | Trans    | Trans  | LCtrl  | LCmd   | LShift | LOpt   |________|           |________| Left   | Down   | Up     | Right  | '      | "        |
     * |          |        |        |        |        |        |        |           |        |        |        |        |        |        |          |
     * |----------+--------+--------+--------+--------+--------|        |           |        |--------+--------+--------+--------+--------+----------|
